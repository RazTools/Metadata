...
public static class BlocksConverter
{
    public static void Convert(MemoryStream stream, double version, double targetVersion)
    {
        ...
        bs.ConvertMetadataSection<MhyIl2Cpp.StringLiteral, UnityIl2Cpp.StringLiteral>(newBS, header.stringLiteralOffset, header.stringLiteralSize, out newHeader.stringLiteralOffset, out newHeader.stringLiteralSize, ConvertersUtils.StringLiteralConverter);
        ...
        bs.ConvertMetadataSection<MhyIl2Cpp.PropertyDefinition, UnityIl2Cpp.PropertyDefinition>(newBS, header.propertiesOffset, header.propertiesSize, out newHeader.propertiesOffset, out newHeader.propertiesSize, ConvertersUtils.PropertyDefinitionConverter);
        bs.ConvertMetadataSection<MhyIl2Cpp.MethodDefinition, UnityIl2Cpp.MethodDefinition>(newBS, header.methodsOffset, header.methodsSize, out newHeader.methodsOffset, out newHeader.methodsSize, ConvertersUtils.MethodDefinitionConverter);
        ...
        bs.ConvertMetadataSection<MhyIl2Cpp.FieldDefinition, UnityIl2Cpp.FieldDefinition>(newBS, header.fieldsOffset, header.fieldsSize, out newHeader.fieldsOffset, out newHeader.fieldsSize, ConvertersUtils.FieldDefinitionConverter);
        ...
        bs.ConvertMetadataSection<MhyIl2Cpp.TypeDefinition, UnityIl2Cpp.TypeDefinition>(newBS, header.typeDefinitionsOffset, header.typeDefinitionsSize, out newHeader.typeDefinitionsOffset, out newHeader.typeDefinitionsSize, ConvertersUtils.TypeDefinitionConverter);
